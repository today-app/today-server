...
class Iface(Interface):
  ...
  def comment_create(user_id, post_id):
    """
    Parameters:
     - user_id
     - post_id
  ...
  def comment_list(user_id, post_id):
    """
    Parameters:
     - user_id
     - post_id
  ...
  def comment_delete(user_id, post_id, comment_id):
    """
    Parameters:
     - user_id
     - post_id
...
class Client:
  ...
  def comment_create(self, user_id, post_id):
    """
    Parameters:
     - user_id
     - post_id
    ...
    self._seqid += 1
    d = self._reqs[self._seqid] = defer.Deferred()
    self.send_comment_create(user_id, post_id)
    return d

  def send_comment_create(self, user_id, post_id):
    oprot = self._oprot_factory.getProtocol(self._transport)
    oprot.writeMessageBegin('comment_create', TMessageType.CALL, self._seqid)
    args = comment_create_args()
    args.user_id = user_id
    args.post_id = post_id
    args.write(oprot)
    oprot.writeMessageEnd()
  ...
  def recv_comment_create(self, iprot, mtype, rseqid):
    d = self._reqs.pop(rseqid)
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(iprot)
      iprot.readMessageEnd()
      return d.errback(x)
    result = comment_create_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return d.callback(result.success)
    return d.errback(TApplicationException(TApplicationException.MISSING_RESULT, "comment_create failed: unknown result"))
  ...
  def comment_list(self, user_id, post_id):
    ...
    self._seqid += 1
    d = self._reqs[self._seqid] = defer.Deferred()
    self.send_comment_list(user_id, post_id)
    return d

  def send_comment_list(self, user_id, post_id):
    oprot = self._oprot_factory.getProtocol(self._transport)
    oprot.writeMessageBegin('comment_list', TMessageType.CALL, self._seqid)
  ...
  def recv_comment_list(self, iprot, mtype, rseqid):
    d = self._reqs.pop(rseqid)
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(iprot)
      iprot.readMessageEnd()
      return d.errback(x)
    result = comment_list_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return d.callback(result.success)
    return d.errback(TApplicationException(TApplicationException.MISSING_RESULT, "comment_list failed: unknown result"))

  def comment_delete(self, user_id, post_id, comment_id):
    """
    Parameters:
     - user_id
     - post_id
    ...
    self._seqid += 1
    d = self._reqs[self._seqid] = defer.Deferred()
    self.send_comment_delete(user_id, post_id, comment_id)
    return d

  def send_comment_delete(self, user_id, post_id, comment_id):
    oprot = self._oprot_factory.getProtocol(self._transport)
    oprot.writeMessageBegin('comment_delete', TMessageType.CALL, self._seqid)
    args = comment_delete_args()
    args.user_id = user_id
    args.post_id = post_id
  ...
  def recv_comment_delete(self, iprot, mtype, rseqid):
    d = self._reqs.pop(rseqid)
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(iprot)
      iprot.readMessageEnd()
      return d.errback(x)
    result = comment_delete_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return d.callback(result.success)
    return d.errback(TApplicationException(TApplicationException.MISSING_RESULT, "comment_delete failed: unknown result"))
...
class Processor(TProcessor):
  ...
  def __init__(self, handler):
    ...
    self._processMap["comment_create"] = Processor.process_comment_create
    self._processMap["comment_list"] = Processor.process_comment_list
    self._processMap["comment_delete"] = Processor.process_comment_delete
  ...
  def process_comment_create(self, seqid, iprot, oprot):
    args = comment_create_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = comment_create_result()
    d = defer.maybeDeferred(self._handler.comment_create, args.user_id, args.post_id)
    d.addCallback(self.write_results_success_comment_create, result, seqid, oprot)
    return d

  def write_results_success_comment_create(self, success, result, seqid, oprot):
    result.success = success
    oprot.writeMessageBegin("comment_create", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_comment_list(self, seqid, iprot, oprot):
    args = comment_list_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = comment_list_result()
    d = defer.maybeDeferred(self._handler.comment_list, args.user_id, args.post_id)
    d.addCallback(self.write_results_success_comment_list, result, seqid, oprot)
    return d

  def write_results_success_comment_list(self, success, result, seqid, oprot):
    result.success = success
    oprot.writeMessageBegin("comment_list", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_comment_delete(self, seqid, iprot, oprot):
    args = comment_delete_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = comment_delete_result()
    d = defer.maybeDeferred(self._handler.comment_delete, args.user_id, args.post_id, args.comment_id)
    d.addCallback(self.write_results_success_comment_delete, result, seqid, oprot)
    return d

  def write_results_success_comment_delete(self, success, result, seqid, oprot):
    result.success = success
    oprot.writeMessageBegin("comment_delete", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class comment_create_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('comment_create_args')
    if self.user_id is not None:
      oprot.writeFieldBegin('user_id', TType.I32, 1)
      oprot.writeI32(self.user_id)
      oprot.writeFieldEnd()
...
class comment_create_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('comment_create_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.I32, 0)
      oprot.writeI32(self.success)
      oprot.writeFieldEnd()
...
class comment_list_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('comment_list_args')
    if self.user_id is not None:
      oprot.writeFieldBegin('user_id', TType.I32, 1)
      oprot.writeI32(self.user_id)
      oprot.writeFieldEnd()
...
class comment_list_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('comment_list_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.LIST, 0)
      oprot.writeListBegin(TType.STRUCT, len(self.success))
...
class comment_delete_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('comment_delete_args')
    if self.user_id is not None:
      oprot.writeFieldBegin('user_id', TType.I32, 1)
      oprot.writeI32(self.user_id)
      oprot.writeFieldEnd()
...
class comment_delete_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('comment_delete_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.BOOL, 0)
      oprot.writeBool(self.success)
      oprot.writeFieldEnd()
